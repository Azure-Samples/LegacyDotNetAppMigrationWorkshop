...
5. Create a secret in the KeyVault with the value as the connection string.

    Go to your KeyVault then Objects and Secrets. Select Generate/Import. Make the secret name something you will remember or save the name somewhere for reference. You will need it in a minute. The secret value should be the connection string from the previous step. Hit Create once you've filled out the secret name and value.

6. Go to the Configuration section in the app service. Add two environment variables:
